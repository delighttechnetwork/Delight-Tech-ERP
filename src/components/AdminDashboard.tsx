...
export default function AdminDashboard({ activeTab, settings, setSettings, classes, setClasses, subjects, setSubjects }: AdminDashboardProps) {
  ...
  const [annForm, setAnnForm] = useState({ title: '', content: '', published: true });
  ...
  const submitAnnouncement = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (r.ok) {
        ...
        setAnnForm({ title: '', content: '', published: true });
                          ...
                          <td className="px-4 py-3 text-right space-x-1.5 whitespace-nowrap">
                            <button
                              onClick={() => {
                                ...
                                setAnnForm({ title: ann.title, content: ann.content, published: !!ann.published });
                              }}
